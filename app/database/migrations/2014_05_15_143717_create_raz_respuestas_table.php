...
class CreateRazRespuestasTable extends Migration {
	...
	public function up()
	{
		Schema::create('raz_respuestas', function(Blueprint $table) {
			$table->increments('id');
			...
			$table->integer('total_rlm_con_piloto')->nullable();
			$table->integer('total_rlm_sin_piloto')->nullable();
