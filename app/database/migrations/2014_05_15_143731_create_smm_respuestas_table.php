...
class CreateSmmRespuestasTable extends Migration {
	...
	public function up()
	{
		Schema::create('smm_respuestas', function(Blueprint $table) {
			$table->increments('id');
			...
			$table->integer('total_mat_con_piloto')->nullable();
			$table->integer('total_mat_sin_piloto')->nullable();
			$table->integer('total_lyl_con_piloto')->nullable();
			$table->integer('total_lyl_sin_piloto')->nullable();
			$table->integer('total_cn_con_piloto')->nullable();
			$table->integer('total_cn_sin_piloto')->nullable();
